...
if ("serviceWorker" in navigator) {
  window.addEventListener("load", () => {
    ...
    console.log(
      "%cFile: App.js, Function: register, Line 35 registerUrl: ",
      "color: pink",
      registerUrl,
    );
    navigator.serviceWorker
      ...
      .then((registration) => {
        console.log(
          "File: index.js, Function: ServiceWorker registration, Line 7 --> SW registered, registration: ",
          registration,
        );
      })
      .catch((registrationError) =>
        console.log(
          "File: index.js, Function: SW registration error: , Line 8 --> registrationError: ",
          registrationError,
        ),
      );
  });
